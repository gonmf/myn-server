...
static void main(loader_args_t * args){
	...
	dprintf(args->out_body, "<html><head><meta HTTP-EQUIV=\"REFRESH\" content=\"%d; url=/\"></head><body><h3>Example of page that redirects after a variable amount of time</h3><p>Redirecting after %d seconds.</p></body></html>", n, n);
